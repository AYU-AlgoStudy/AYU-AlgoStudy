...
## 5주차 5번 문제 BOJ 12865번
🔗| 문제 Link
https://www.acmicpc.net/problem/12865

### 문제 풀이
https://github.com/zldzldzz/Algorithm/commit/545d86b8d244de4fff45aa967e197617edd4ed0e

### 개념 정리

**문제 풀이 과정에서 개선점 & 배운점**

이번 문제는 진짜 거의 다 풇었다고 생각했지만 반복문의 조건을 제대로 선정하지 못했다.
나는 0부터 올라가는 식으로 코드를 작성했지만 풀 수 없었다.
원인은 한번 사용한 것은 다시 사용할 수 없다는 조건 때문이었다.
물건을 기준으로 반복문을 돌면 이미 처리한 물건이 다시 들어가는 일이 없다.
또한 물건이 전혀 없는 무게 부터 물건의 무게까지만 하여 불필요한 조건을 최소화하기 위해 노력했다.

### 총평

아직도 DP가 어렵다고 느껴진다. 다른 알고리즘들은 명확한 의사코드를 정의하면 비교적 이해가 되었지만 문제별로 접근 방식이 너무 다른 것 같다.
...
이번주 내내 dp를 풀은 것 같지만 아직도 DP 알고리즘을 온전히 습득하지 못한 것 같아 아쉽다.